...
const NATIVE_TABS_ROUTE_EXCLUSIONS = {
  ...
  FoodSearch: 'Root-stack add-food modal presented from the tab host.',
  ...
  Chat: 'Root-stack assistant route presented above the tab host.',
...
describe('native header navigation contract', () => {
  ...
  it('requires every root-stack screen to have native-tabs coverage or an explicit exclusion reason', () => {
    ...
    const nativeTabsModeRoutes = new Set(['Tabs', ...nativeTabScreens]);
